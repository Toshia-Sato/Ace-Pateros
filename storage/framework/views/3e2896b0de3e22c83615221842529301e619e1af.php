...
<head>
    ...
    <!-- Scripts -->
    <script src="<?php echo e(asset('js/side.js')); ?>" defer></script>
    ...
    <style>
        ...
        *::after {
        ...
        color: #fff;
        transition: all 0.3s;
        border-right: 40px solid #006000;
        }
    ...
    <div id="app">
        <div class="wrapper">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="#" style="background:#800000"></a>
                </li>
                ...
                <li>
                    <a style="background:#800000" href="#"></a>
                </li>
                <li class="text-center">
                    <a style="background:#800000; color:#ffffff;" href="#">@ ALL RIGHTS RESERVED 2021</a>
                </li>
...
<?php /**PATH D:\laravel\ace-pateros\resources\views/layouts/app.blade.php ENDPATH**/ ?>