    ...
    <table class="table table-bordered table-responsive-lg">
        ...
        <?php $__currentLoopData = $schedule; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $schedules): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td><?php echo e($schedules->id); ?></td>
                <td><?php echo e($schedules->jobtitle); ?></td>
                <td><?php echo e($schedules->description); ?></td>
                <td>
                <img src="/storage/<?php echo e($schedules->image); ?>" alt="" class="img-thumbnail" style="width: 100px;">
                </td>

                <td>
                    <form action="<?php echo e(route('schedule.destroy', $schedules->id)); ?>" method="POST">

                        <a href="schedule/<?php echo e($schedules->id); ?>/edit">
...
<div class="container"><?php echo e($schedule->links()); ?></div>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel\ace-pateros\resources\views/schedule/index.blade.php ENDPATH**/ ?>