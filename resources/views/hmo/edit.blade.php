...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-primary" href="{{ route('hmo.index') }}" title="Go back"> <i class="fas fa-backward "></i> </a>
            </div>
        </div>
    </div>
    ...
    @method('PATCH')
        ...
        <input type="hidden" name="id" value="{{$hmo->id}}">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <br>
                    <input type="text" name="name" class="form-control" value="{{$hmo->name}}">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
